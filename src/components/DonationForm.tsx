...
const DonationForm: React.FC<DonationFormProps> = ({ isOpen, onClose, onSubmit }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Create form data object without contactInfo
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <input
                ...
                required
                className="block w-full pl-10 pr-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:text-white transition-colors duration-300"
              ...
              <button
                ...
                className="absolute right-3 top-1/2 -translate-y-1/2 text-sm text-green-600 dark:text-green-400 hover:text-green-700 dark:hover:text-green-300"
              >
