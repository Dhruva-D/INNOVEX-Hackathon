  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white dark:from-gray-900 dark:to-gray-800 transition-all duration-300">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-24">
        <h1 className="text-3xl font-extrabold text-gray-900 dark:text-white mb-8">Food Seeker Homepage</h1>
        <div className="card-3d bg-white dark:bg-gray-800 shadow overflow-hidden sm:rounded-lg transition-all duration-300">
          <div className="card-3d-content px-4 py-5 sm:px-6">
            <h2 className="text-lg leading-6 font-medium text-gray-900 dark:text-white">Welcome to your food seeker homepage</h2>
            <p className="mt-1 max-w-2xl text-sm text-gray-500 dark:text-gray-300">
              From here, you can find available food donations in your area.
            </p>
          </div>
          <div className="border-t border-gray-200 dark:border-gray-700">
            <dl>
              ...
              <div className="bg-gray-50 dark:bg-gray-700 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Active Requests</dt>
                <dd className="mt-1 text-sm text-gray-900 dark:text-white sm:mt-0 sm:col-span-2">0</dd>
              </div>
              <div className="bg-white dark:bg-gray-800 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Completed Requests</dt>
                <dd className="mt-1 text-sm text-gray-900 dark:text-white sm:mt-0 sm:col-span-2">0</dd>
              </div>
            </dl>
          </div>
        ...
        {/* Available Donations */}
        <div className="mt-10">
          <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Available Donations Near You</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="glass card-3d bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300">No donations available in your area yet</p>
